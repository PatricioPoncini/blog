...
Es una de las técnicas más simples y viejas de encriptar un mensaje. Su funcionamiento se basa en desplazar las letras de cada palabra un número fijo de veces hacia adelante en el alfabeto. Por ejemplo, la letra "t" encriptada en cifrado César sería "x" moviéndonos 4 veces en el alfabeto. Una nota importante de este cifrado es que solo puede elegirse hasta el número 25 para desplazarse, ya que el alfabeto inglés tiene 26 letras, y ese es el límite antes de volver a empezar desde la primera letra.
